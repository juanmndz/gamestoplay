...
class PostCreate extends Component {
  ...
  handleFormSubmit(props) {
    const { title, description, category, privateCheck, imageUrl, gameUrl, created_at } = props;

    this.props.createPost({ title, description, category, privateCheck, imageUrl, gameUrl, created_at });
  }
